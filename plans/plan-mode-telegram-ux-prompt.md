...
- See:
  - `src/generated/codex/v2/TurnStartParams.ts`
  - `src/generated/codex/CollaborationMode.ts`
  - `src/generated/codex/ModeKind.ts`

2. Active turns cannot be switched into plan mode via steer.
- `turn/steer` does not expose collaboration mode.
- See:
  - `src/generated/codex/v2/TurnSteerParams.ts`
...
- See:
  - `src/generated/codex/v2/ThreadMetadataUpdateParams.ts`
  - `src/domain.ts`
  - `src/db.ts`
...
- Relevant files:
  - `src/bridge.ts`
  - `src/bridge/turn-lifecycle.ts`
  - `src/bridge/notifications.ts`
  - `src/codex.ts`
  - `src/generated/codex/v2/ThreadItem.ts`
  - `src/generated/codex/ServerNotification.ts`
...
- Relevant files:
  - `src/bridge/request-coordinator.ts`
  - `src/bridge/requests.ts`
  - `src/generated/codex/v2/ToolRequestUserInputQuestion.ts`
  - `src/generated/codex/v2/ToolRequestUserInputOption.ts`
  - `src/generated/codex/v2/ToolRequestUserInputResponse.ts`
