...
describe("TelegramCodexBridge", () => {
  ...
  it("uses a private supergroup deep link when the chat has no username", async () => {
  ...
  it("continues session startup when copying the root prompt into the topic fails", async () => {
